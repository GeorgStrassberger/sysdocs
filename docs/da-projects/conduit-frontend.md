...
You can also start the Website with [Docker Compose](https://github.com/GeorgStrassberger/conduit-frontend/blob/docker/docker-compose.yml) by running:
...
![conduit_page.png](img/conduit_page.png)